...
#             if j in 'аеёиоуыэюя':
#                 countVowels += 1
#         spisok_1.append(countVowels)
#     return (len(spisok_1)) == (spisok_1.count(spisok_1[0]))
...
# Напишите функцию def print_operation_table(operation, num_rows=6, num_columns=6), которая принимает в качестве аргумента функцию, 
